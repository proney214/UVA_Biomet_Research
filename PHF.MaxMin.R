...
Station.test= read_excel("PHF.maxmin.xlsx", na="NA", sheet = "UseThis")
...
write.csv(df_output,"PHF.maxmin.output2.csv",row.names=FALSE)
#
...
library(imputeTS)
raw <- read.csv("PHF.maxmin.output2.csv", sep = ",")
Final <- na_interpolation(raw)
write.csv(Final, "~/Desktop/EVSC_Research/PHF.maxmin2.FullInt3.csv")
