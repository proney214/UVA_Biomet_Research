...
RICF <- read_excel("~/Desktop/RIC.working.weatherprep.xlsx")
...
plot(pred1.MaxTF,"overall",xlab="MaxTF",y="Relative Risk",lwd=3,ylim=c(0.7,1.3),main="RIC Comparison Model Overall Cumulative Association")
...
plot(pred1.MaxTF,"contour",xlab="MaxTF",key.title=title("RR"),plot.title=title("RIC Comparison Model",xlab="MaxTF",ylab="Lag (days)"))
