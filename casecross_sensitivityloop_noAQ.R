...
for (i in (c(7:28))) {
  model0_HeatWavesModerate_exc0 = casecross(Mort ~ HeatWavesModerate, stratalength = i, exclusion = 0, data=VJIexc_Hot)
  model1_HeatWavesModerate_exc0 = casecross(Mort ~ HeatWavesModerate, stratalength = i, exclusion = 0, data=VJI519exc_Hot)
  model2_HeatWavesModerate_exc0 = casecross(Mort ~ HeatWavesModerate, stratalength = i, exclusion = 0, data=VJI20exc_Hot)
  ...
  se0_HeatWavesModerate_exc0 = sum0_HeatWavesModerate_exc0[3]
  ...
  se1_HeatWavesModerate_exc0 = sum1_HeatWavesModerate_exc0[3]
  ...
  se2_HeatWavesModerate_exc0 = sum2_HeatWavesModerate_exc0[3]
...
Full_exc0 <- ggplot(myORtable0_HeatWavesModerate_exc0_complete) +
  ...
  labs(title="VJI Full Mort HeatWavesModerate exc=0",y="Odds Ratio")+
...
Big_exc0 <- ggplot(myORtable1_HeatWavesModerate_exc0_complete) +
  ...
  labs(title="VJI 2005-2019 Mort HeatWavesModerate exc=0",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
Little_exc0 <- ggplot(myORtable2_HeatWavesModerate_exc0_complete) +
  ...
  labs(title="VJI 2020 Mort HeatWavesModerate exc=0",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
for (i in (c(7:28))) {
  model0_HeatWavesModerate__exc1 = casecross(Mort ~ HeatWavesModerate, stratalength = i, exclusion = 1, data=VJIexc_Hot)
  model1_HeatWavesModerate__exc1 = casecross(Mort ~ HeatWavesModerate, stratalength = i, exclusion = 1, data=VJI519exc_Hot)
  model2_HeatWavesModerate__exc1 = casecross(Mort ~ HeatWavesModerate, stratalength = i, exclusion = 1, data=VJI20exc_Hot)
  ...
  se0_HeatWavesModerate__exc1 = sum0_HeatWavesModerate__exc1[3]
  ...
  se1_HeatWavesModerate__exc1 = sum1_HeatWavesModerate__exc1[3]
  ...
  se2_HeatWavesModerate__exc1 = sum2_HeatWavesModerate__exc1[3]
...
Full_exc1 <- ggplot(myORtable0_HeatWavesModerate__exc1_complete) +
  ...
  labs(title="VJI Full Mort HeatWavesModerate exc=1",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
Big_exc1 <- ggplot(myORtable1_HeatWavesModerate__exc1_complete) +
  ...
  labs(title="VJI 2005-2019 Mort HeatWavesModerate exc=1",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
Little_exc1 <- ggplot(myORtable2_HeatWavesModerate__exc1_complete) +
  ...
  labs(title="VJI 2020 Mort HeatWavesModerate exc=1",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
for (i in (c(7:28))) {
  model0_HeatWavesModerate__exc2 = casecross(Mort ~ HeatWavesModerate, stratalength = i, exclusion = 2, data=VJIexc_Hot)
  model1_HeatWavesModerate__exc2 = casecross(Mort ~ HeatWavesModerate, stratalength = i, exclusion = 2, data=VJI519exc_Hot)
  model2_HeatWavesModerate__exc2 = casecross(Mort ~ HeatWavesModerate, stratalength = i, exclusion = 2, data=VJI20exc_Hot)
  ...
  se0_HeatWavesModerate__exc2 = sum0_HeatWavesModerate__exc2[3]
...
Full_exc2 <- ggplot(myORtable0_HeatWavesModerate__exc2_complete) +
  ...
  labs(title="VJI Full Mort HeatWavesModerate exc=2",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
Big_exc2 <- ggplot(myORtable1_HeatWavesModerate__exc2_complete) +
  ...
  labs(title="VJI 2005-2019 Mort HeatWavesModerate exc=2",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
Little_exc2 <- ggplot(myORtable2_HeatWavesModerate__exc2_complete) +
  ...
  labs(title="VJI 2020 Mort HeatWavesModerate exc=2",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)

png("CaseCross_HeatWavesModerate_VJI.png",width = 1000, height = 800)
...
for (i in (c(7:28))) {
  model0_HeatWavesSevere_exc0 = casecross(Mort ~ HeatWavesSevere, stratalength = i, exclusion = 0, data=VJIexc_Hot)
  model1_HeatWavesSevere_exc0 = casecross(Mort ~ HeatWavesSevere, stratalength = i, exclusion = 0, data=VJI519exc_Hot)
  model2_HeatWavesSevere_exc0 = casecross(Mort ~ HeatWavesSevere, stratalength = i, exclusion = 0, data=VJI20exc_Hot)
  
  sum0_HeatWavesSevere_exc0 <- summary(model0_HeatWavesSevere_exc0)
  coef0_HeatWavesSevere_exc0 = sum0_HeatWavesSevere_exc0[1]
  se0_HeatWavesSevere_exc0 = sum0_HeatWavesSevere_exc0[3]
  
  sum1_HeatWavesSevere_exc0 <- summary(model1_HeatWavesSevere_exc0)
  coef1_HeatWavesSevere_exc0 = sum1_HeatWavesSevere_exc0[1]
  se1_HeatWavesSevere_exc0 = sum1_HeatWavesSevere_exc0[3]
  
  sum2_HeatWavesSevere_exc0 <- summary(model2_HeatWavesSevere_exc0)
  coef2_HeatWavesSevere_exc0 = sum2_HeatWavesSevere_exc0[1]
  se2_HeatWavesSevere_exc0 = sum2_HeatWavesSevere_exc0[3]
...
Full_exc0 <- ggplot(myORtable0_HeatWavesSevere_exc0_complete) +
  ...
  labs(title="VJI Full Mort HeatWavesSevere exc=0",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
Big_exc0 <- ggplot(myORtable1_HeatWavesSevere_exc0_complete) +
  ...
  labs(title="VJI 2005-2019 Mort HeatWavesSevere exc=0",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
Little_exc0 <- ggplot(myORtable2_HeatWavesSevere_exc0_complete) +
  ...
  labs(title="VJI 2020 Mort HeatWavesSevere exc=0",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
for (i in (c(7:28))) {
  model0_HeatWavesSevere__exc1 = casecross(Mort ~ HeatWavesSevere, stratalength = i, exclusion = 1, data=VJIexc_Hot)
  model1_HeatWavesSevere__exc1 = casecross(Mort ~ HeatWavesSevere, stratalength = i, exclusion = 1, data=VJI519exc_Hot)
  model2_HeatWavesSevere__exc1 = casecross(Mort ~ HeatWavesSevere, stratalength = i, exclusion = 1, data=VJI20exc_Hot)
  
  sum0_HeatWavesSevere__exc1 <- summary(model0_HeatWavesSevere__exc1)
  coef0_HeatWavesSevere__exc1 = sum0_HeatWavesSevere__exc1[1]
  se0_HeatWavesSevere__exc1 = sum0_HeatWavesSevere__exc1[3]
  
  sum1_HeatWavesSevere__exc1 <- summary(model1_HeatWavesSevere__exc1)
  coef1_HeatWavesSevere__exc1 = sum1_HeatWavesSevere__exc1[1]
  se1_HeatWavesSevere__exc1 = sum1_HeatWavesSevere__exc1[3]
  
  sum2_HeatWavesSevere__exc1 <- summary(model2_HeatWavesSevere__exc1)
  coef2_HeatWavesSevere__exc1 = sum2_HeatWavesSevere__exc1[1]
  se2_HeatWavesSevere__exc1 = sum2_HeatWavesSevere__exc1[3]
...
Full_exc1 <- ggplot(myORtable0_HeatWavesSevere__exc1_complete) +
  ...
  labs(title="VJI Full Mort HeatWavesSevere exc=1",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
Big_exc1 <- ggplot(myORtable1_HeatWavesSevere__exc1_complete) +
  ...
  labs(title="VJI 2005-2019 Mort HeatWavesSevere exc=1",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
Little_exc1 <- ggplot(myORtable2_HeatWavesSevere__exc1_complete) +
  ...
  labs(title="VJI 2020 Mort HeatWavesSevere exc=1",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
for (i in (c(7:28))) {
  model0_HeatWavesSevere__exc2 = casecross(Mort ~ HeatWavesSevere, stratalength = i, exclusion = 2, data=VJIexc_Hot)
  model1_HeatWavesSevere__exc2 = casecross(Mort ~ HeatWavesSevere, stratalength = i, exclusion = 2, data=VJI519exc_Hot)
  model2_HeatWavesSevere__exc2 = casecross(Mort ~ HeatWavesSevere, stratalength = i, exclusion = 2, data=VJI20exc_Hot)
  
  sum0_HeatWavesSevere__exc2 <- summary(model0_HeatWavesSevere__exc2)
  coef0_HeatWavesSevere__exc2 = sum0_HeatWavesSevere__exc2[1]
  se0_HeatWavesSevere__exc2 = sum0_HeatWavesSevere__exc2[3]
  
  sum1_HeatWavesSevere__exc2 <- summary(model1_HeatWavesSevere__exc2)
  coef1_HeatWavesSevere__exc2 = sum1_HeatWavesSevere__exc2[1]
  se1_HeatWavesSevere__exc2 = sum1_HeatWavesSevere__exc2[3]
  
  sum2_HeatWavesSevere__exc2 <- summary(model2_HeatWavesSevere__exc2)
  coef2_HeatWavesSevere__exc2 = sum2_HeatWavesSevere__exc2[1]
  se2_HeatWavesSevere__exc2 = sum2_HeatWavesSevere__exc2[3]
...
Full_exc2 <- ggplot(myORtable0_HeatWavesSevere__exc2_complete) +
  ...
  labs(title="VJI Full Mort HeatWavesSevere exc=2",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
Big_exc2 <- ggplot(myORtable1_HeatWavesSevere__exc2_complete) +
  ...
  labs(title="VJI 2005-2019 Mort HeatWavesSevere exc=2",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
Little_exc2 <- ggplot(myORtable2_HeatWavesSevere__exc2_complete) +
  ...
  labs(title="VJI 2020 Mort HeatWavesSevere exc=2",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)

png("CaseCross_HeatWavesSevere_VJI.png",width = 1000, height = 800)
ggarrange(Full_exc0,Full_exc1,Full_exc2,Big_exc0,Big_exc1,Big_exc2,Little_exc0,Little_exc1,Little_exc2)
dev.off()
...
for (i in (c(7:28))) {
  model0_HeatWavesExtreme_exc0 = casecross(Mort ~ HeatWavesExtreme, stratalength = i, exclusion = 0, data=VJIexc_Hot)
  model1_HeatWavesExtreme_exc0 = casecross(Mort ~ HeatWavesExtreme, stratalength = i, exclusion = 0, data=VJI519exc_Hot)
  model2_HeatWavesExtreme_exc0 = casecross(Mort ~ HeatWavesExtreme, stratalength = i, exclusion = 0, data=VJI20exc_Hot)
  
  sum0_HeatWavesExtreme_exc0 <- summary(model0_HeatWavesExtreme_exc0)
  coef0_HeatWavesExtreme_exc0 = sum0_HeatWavesExtreme_exc0[1]
  se0_HeatWavesExtreme_exc0 = sum0_HeatWavesExtreme_exc0[3]
  
  sum1_HeatWavesExtreme_exc0 <- summary(model1_HeatWavesExtreme_exc0)
  coef1_HeatWavesExtreme_exc0 = sum1_HeatWavesExtreme_exc0[1]
  se1_HeatWavesExtreme_exc0 = sum1_HeatWavesExtreme_exc0[3]
  
  sum2_HeatWavesExtreme_exc0 <- summary(model2_HeatWavesExtreme_exc0)
  coef2_HeatWavesExtreme_exc0 = sum2_HeatWavesExtreme_exc0[1]
  se2_HeatWavesExtreme_exc0 = sum2_HeatWavesExtreme_exc0[3]
...
Full_exc0 <- ggplot(myORtable0_HeatWavesExtreme_exc0_complete) +
  ...
  labs(title="VJI Full Mort HeatWavesExtreme exc=0",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
Big_exc0 <- ggplot(myORtable1_HeatWavesExtreme_exc0_complete) +
  ...
  labs(title="VJI 2005-2019 Mort HeatWavesExtreme exc=0",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
Little_exc0 <- ggplot(myORtable2_HeatWavesExtreme_exc0_complete) +
  ...
  labs(title="VJI 2020 Mort HeatWavesExtreme exc=0",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
for (i in (c(7:28))) {
  model0_HeatWavesExtreme__exc1 = casecross(Mort ~ HeatWavesExtreme, stratalength = i, exclusion = 1, data=VJIexc_Hot)
  model1_HeatWavesExtreme__exc1 = casecross(Mort ~ HeatWavesExtreme, stratalength = i, exclusion = 1, data=VJI519exc_Hot)
  model2_HeatWavesExtreme__exc1 = casecross(Mort ~ HeatWavesExtreme, stratalength = i, exclusion = 1, data=VJI20exc_Hot)
  ...
  se0_HeatWavesExtreme__exc1 = sum0_HeatWavesExtreme__exc1[3]
  ...
  se1_HeatWavesExtreme__exc1 = sum1_HeatWavesExtreme__exc1[3]
  ...
  se2_HeatWavesExtreme__exc1 = sum2_HeatWavesExtreme__exc1[3]
...
Full_exc1 <- ggplot(myORtable0_HeatWavesExtreme__exc1_complete) +
  ...
  labs(title="VJI Full Mort HeatWavesExtreme exc=1",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
Big_exc1 <- ggplot(myORtable1_HeatWavesExtreme__exc1_complete) +
  ...
  labs(title="VJI 2005-2019 Mort HeatWavesExtreme exc=1",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
Little_exc1 <- ggplot(myORtable2_HeatWavesExtreme__exc1_complete) +
  ...
  labs(title="VJI 2020 Mort HeatWavesExtreme exc=1",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
for (i in (c(7:28))) {
  model0_HeatWavesExtreme__exc2 = casecross(Mort ~ HeatWavesExtreme, stratalength = i, exclusion = 2, data=VJIexc_Hot)
  model1_HeatWavesExtreme__exc2 = casecross(Mort ~ HeatWavesExtreme, stratalength = i, exclusion = 2, data=VJI519exc_Hot)
  model2_HeatWavesExtreme__exc2 = casecross(Mort ~ HeatWavesExtreme, stratalength = i, exclusion = 2, data=VJI20exc_Hot)
  ...
  se0_HeatWavesExtreme__exc2 = sum0_HeatWavesExtreme__exc2[3]
  ...
  se1_HeatWavesExtreme__exc2 = sum1_HeatWavesExtreme__exc2[3]
  ...
  se2_HeatWavesExtreme__exc2 = sum2_HeatWavesExtreme__exc2[3]
...
Full_exc2 <- ggplot(myORtable0_HeatWavesExtreme__exc2_complete) +
  ...
  labs(title="VJI Full Mort HeatWavesExtreme exc=2",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
Big_exc2 <- ggplot(myORtable1_HeatWavesExtreme__exc2_complete) +
  ...
  labs(title="VJI 2005-2019 Mort HeatWavesExtreme exc=2",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)
...
Little_exc2 <- ggplot(myORtable2_HeatWavesExtreme__exc2_complete) +
  ...
  labs(title="VJI 2020 Mort HeatWavesExtreme exc=2",y="Odds Ratio")+
  geom_hline(yintercept=1, linetype="dashed", color = "red")+
  ylim(0.7,1.3)

png("CaseCross_HeatWavesExtreme_VJI.png",width = 1000, height = 800)
ggarrange(Full_exc0,Full_exc1,Full_exc2,Big_exc0,Big_exc1,Big_exc2,Little_exc0,Little_exc1,Little_exc2)
dev.off()
