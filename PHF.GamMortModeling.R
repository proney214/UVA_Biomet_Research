...
#PHFF %>%
 # mutate_at(vars(Ozone,PM2.5), ~replace_na(.,mean(., na.rm = TRUE)))
...
model0=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4),family="quasipoisson")
a=summary(model0)
plot(model0)

model1=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(dow),family="quasipoisson")
A=summary(model1)
#plot(model1)

model2=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(holidays),family="quasipoisson")
B=summary(model2)
#plot(model2)

model3=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(dow)+as.factor(holidays),family="quasipoisson")
C=summary(model3)
#plot(model3)

model4=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(HeatWavesModerate),family="quasipoisson")
D=summary(model4)
#plot(model4)

model5=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(HeatWavesSevere),family="quasipoisson")
E=summary(model5)
#plot(model5)

model6=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(HeatWavesExtreme),family="quasipoisson")
F=summary(model6)
#plot(model6)

model7=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(ColdWavesModerate),family="quasipoisson")
G=summary(model7)
#plot(model7)

model8=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(ColdWavesSevere),family="quasipoisson")
H=summary(model8)
#plot(model8)

model9=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(ColdWavesExtreme),family="quasipoisson")
I=summary(model9)
#plot(model9)

model10=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(WinterWeather),family="quasipoisson")
J=summary(model10)
#plot(model10)

model11=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(HotDaysExtreme),family="quasipoisson")
K=summary(model11)
#plot(model11)

model12=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(dow)+as.factor(holidays)+as.factor(WinterWeather),family="quasipoisson")
L=summary(model12)
#plot(model12)

model13=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(holidays)+as.factor(WinterWeather),family="quasipoisson")
M=summary(model13)
#plot(model13)

model14=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(dow)+as.factor(WinterWeather),family="quasipoisson")
N=summary(model14)
#plot(model14)

model15=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(dow)+as.factor(HeatWavesModerate),family="quasipoisson")
O=summary(model15)
#plot(model15)

model16=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(dow)+as.factor(ColdWavesModerate),family="quasipoisson")
P=summary(model16)
#plot(model16)

model17=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(WinterWeather)+as.factor(ColdWavesModerate),family="quasipoisson")
Q=summary(model17)
#plot(model17)

model18=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+as.factor(holidays)+as.factor(ColdWavesModerate),family="quasipoisson")
R=summary(model18)
#plot(model18)
...
### Test Best Model
model99=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+s(DTRF,k=4)+as.factor(ColdWavesSevere),family="quasipoisson")
S=summary(model99)
#plot(model99)

model98=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+s(RH1pm,k=4)+as.factor(ColdWavesSevere),family="quasipoisson")
T=summary(model98)
#plot(model98)

model97=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+s(RH1pm,k=4)+s(Ozone,k=4)+as.factor(ColdWavesSevere),family="quasipoisson")
U=summary(model97)
#plot(model97)

model96=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+s(RH1pm,k=4)+s(PM2.5,k=4)+as.factor(ColdWavesSevere),family="quasipoisson")
V=summary(model96)
#plot(model99)

model95=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+s(RH1pm,k=4)+s(PM2.5,k=4)+s(Ozone,k=4)+as.factor(ColdWavesSevere),family="quasipoisson")
W=summary(model95)
#plot(model99)

model94=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+s(HxF1pm,k=4)+as.factor(ColdWavesSevere),family="quasipoisson")
X=summary(model94)
#plot(model98)

model93=gam(mort~s(Trend,k=16*4)+s(TF1pm,k=4)+s(TwF1pm,k=4)+as.factor(ColdWavesSevere),family="quasipoisson")
Y=summary(model93)
#plot(model98)
...
model90=gam(mort~s(Trend,k=16*4)+s(MaxTF,k=4)+s(RH1am,k=4)+as.factor(ColdWavesSevere),family="quasipoisson")
plot(model90)
