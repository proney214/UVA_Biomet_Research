## Average deaths per heatwave day
...
HWfinaldailymortsdf <- rbind(as.matrix(CHOdailymortsdf), as.matrix(EMVdailymortsdf), as.matrix(EZFdailymortsdf), as.matrix(IADdailymortsdf), as.matrix(LYHdailymortsdf), as.matrix(OKVdailymortsdf), as.matrix(ORFdailymortsdf), as.matrix(PHFdailymortsdf), as.matrix(RICdailymortsdf), as.matrix(ROAdailymortsdf), as.matrix(SHDdailymortsdf), as.matrix(VJIdailymortsdf))
rownames(HWfinaldailymortsdf) <- c("CHO","EMV","EZF","IAD","LYH","OKV","ORF","PHF","RIC","ROA","SHD","VJI")
colnames(HWfinaldailymortsdf) <- c("FullHW0520","J0510","J1115","J1620","J0519","J20")
HWfinaldailymortsdf <- data.frame(HWfinaldailymortsdf)
HWfinaldailymortsdf$diff <- HWfinaldailymortsdf$J20 - HWfinaldailymortsdf$J0519
View(HWfinaldailymortsdf)
