...
PHF_working_weatherprep <- read_excel("~/Desktop/PHF.working.weatherprep.xlsx", sheet = "Sheet1")
...
finaldailymortsdf <- rbind(as.matrix(CHOdailymortsdf), as.matrix(EMVdailymortsdf), as.matrix(EZFdailymortsdf), as.matrix(IADdailymortsdf), as.matrix(LYHdailymortsdf), as.matrix(OKVdailymortsdf), as.matrix(ORFdailymortsdf), as.matrix(PHFdailymortsdf), as.matrix(RICdailymortsdf), as.matrix(ROAdailymortsdf), as.matrix(SHDdailymortsdf), as.matrix(VJIdailymortsdf))
rownames(finaldailymortsdf) <- c("CHO","EMV","EZF","IAD","LYH","OKV","ORF","PHF","RIC","ROA","SHD","VJI")
colnames(finaldailymortsdf) <- c("Full0520AllDays","J0510","J1115","J1620","J0519","J20")
finaldailymortsdf <- data.frame(finaldailymortsdf)
finaldailymortsdf$diff <- finaldailymortsdf$J20 - finaldailymortsdf$J0519
View(finaldailymortsdf)
